...
{
//Onur 
	//path.calculateWavefront(); // Construct matrix with wavefront algorithm + find the path
	//cout << "A PATH HAS BEEN FOUND \n";
	
	//path.pathImprove();//Improve the path 
	//cout << "PATH IMPROVED \n";
	//Bunu eklersen yeniden ekler
	//path.printMatrix()


	path.AddPotantielField(); // Fill the matrix with the value of potantiel field
	cout << "1. Step Done - Potantiel Field Added" << "\n\n";
//Onur
