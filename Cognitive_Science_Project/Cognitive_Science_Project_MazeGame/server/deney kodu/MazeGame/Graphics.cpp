...
int main(int argc, char **argv)
{
	...
	myCamera->position.setValue(SHIFT_X, 160, 100 + SHIFT_Z/*BOARD_WIDTH+20/* 100, 200*/);//100
	myCamera->pointAt(SbVec3f(SHIFT_X, -25, -150 + SHIFT_Z/*-20/* -100, -200*/));//-38
	myViewer->saveHomePosition();
	myViewer->setTitle("Koc University - Maze Game - Player 1");
	...
	myCamera2->position.setValue(SHIFT_X, 160, 100+SHIFT_Z/*BOARD_WIDTH+20/* 100, 200*/);
	myCamera2->pointAt(SbVec3f(SHIFT_X, -25, -150+SHIFT_Z/*-20/* -100, -200*/));
