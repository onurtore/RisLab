...
#define DEVICE1 "Default PHANToM"  //phantom1"//Omnigrey"
//#define DEVICE2 "Omni"
...
const float BOARD_WIDTH			= 200.0f;
const float BOARD_DEPTH_STR     = 30.0f;//15.0f;
const float BOARD_DEPTH_MIXED	= 82.0f;//15.0f;
...
const float COEFFICIENT_FRICTION_STATIC			 = 0.5;// 0.19f;
const float COEFFICIENT_FRICTION_KINETIC	     = 0.15f;
const float COEFFICIENT_FRICTION_ROT_STATIC      = 0.5;//0.20f;
const float COEFFICIENT_FRICTION_ROT             = 0.5;//0.19f;
#else
...
const float BALL_WIDTH  = 24.0f;//8.0f;
