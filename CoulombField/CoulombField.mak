...
ifdef DEBUG
CFG=CoulombField_DEBUG
else
CFG=CoulombField_RELEASE
endif
...
ifeq "$(CFG)"  "CoulombField_RELEASE"
CFLAGS+=-W -fexceptions -O2 $(INCLUDES) -Dlinux -DNDEBUG
LD=$(CXX) $(CXXFLAGS)
TARGET=CoulombField
LIBS+=-lHD -lHDU -lglut -lGL -lGLU -lrt

else
ifeq "$(CFG)"  "CoulombField_DEBUG"
CFLAGS+=-W -fexceptions -g -O0 $(INCLUDES) -Dlinux -D_DEBUG
LD=$(CXX) $(CXXFLAGS)
TARGET=CoulombField
LIBS+=-lHD -lHDUD -lglut -lGL -lGLU -lrt
endif
endif
